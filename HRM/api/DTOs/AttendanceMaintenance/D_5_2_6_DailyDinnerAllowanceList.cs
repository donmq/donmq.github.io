...
{
    public class DailyDinnerAllowanceList_Param
    {
    ...
    public class DailyDinnerAllowanceList_Table
    {
    ...
    public class DailyDinnerAllowanceList_HAOM_DTO : HRMS_Att_Overtime_Maintain
    {
        public string Local_Full_Name { get; set; }
