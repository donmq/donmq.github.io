...
{
    public class DailyNoNightShiftHoursList_Param
    {
    ...
    public class DailyNoNightShiftHoursList_Table
    {
    ...
    public class DailyNoNightShiftHoursList_HAOM_DTO : HRMS_Att_Overtime_Maintain
    {
        public string Local_Full_Name { get; set; }
