...
public partial class HRMS_Emp_Transfer_Operation
{
    [Key]
    [StringLength(50)]
    ...
    [StringLength(10)]
    [Unicode(false)]
    public string Reason_for_Change_Before { get; set; }

    /// <summary>
    /// 生效日期
    /// </summary>
    [Column(TypeName = "date")]
    public DateTime Effective_Date_Before { get; set; }

    /// <summary>
    /// 生效狀態
    /// </summary>
    public bool Effective_Status_Before { get; set; }
    ...
    [StringLength(20)]
    [Unicode(false)]
    public string Update_By_Before { get; set; }

    /// <summary>
    /// 異動日期
    /// </summary>
    [Column(TypeName = "datetime")]
    public DateTime Update_Timee_Before { get; set; }
    ...
    [StringLength(10)]
    [Unicode(false)]
    public string Reason_for_Change_After { get; set; }

    /// <summary>
    /// 生效日期_異動後
    /// </summary>
    [Column(TypeName = "date")]
    public DateTime? Effective_Date_After { get; set; }

    /// <summary>
    /// 生效狀態
    /// </summary>
    public bool Effective_Status_After { get; set; }
    ...
    [StringLength(20)]
    [Unicode(false)]
    public string Update_By_After { get; set; }

    /// <summary>
    /// 異動日期
    /// </summary>
    [Column(TypeName = "datetime")]
    public DateTime Update_Time_After { get; set; }
}
