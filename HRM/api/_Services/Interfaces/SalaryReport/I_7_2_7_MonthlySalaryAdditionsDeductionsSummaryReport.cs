...
namespace API._Services.Interfaces.SalaryReport
{
    ...
    public interface I_7_2_7_MonthlySalaryAdditionsDeductionsSummaryReport
    {
        Task<OperationResult> GetTotalRows(MonthlySalaryAdditionsDeductionsSummaryReportParam param);
        Task<OperationResult> Download(MonthlySalaryAdditionsDeductionsSummaryReportParam param);
