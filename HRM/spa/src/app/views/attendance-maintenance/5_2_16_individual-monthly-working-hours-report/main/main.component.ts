...
import { IndividualMonthlyWorkingHoursReportMemory, IndividualMonthlyWorkingHoursReportParam } from '@models/attendance-maintenance/5_2_16_individual-monthly-working-hours-report';
@Component({
  selector: 'app-main',
