...
import { AfterViewInit, ElementRef, HostListener, Inject, Input, NgZone, OnDestroy, PLATFORM_ID, Renderer2, SimpleChanges, TemplateRef, ViewContainerRef } from '@angular/core';
import { TooltipOptions } from '@options/tooltip-options';
import { ZIndexUtils } from '@options/zindex-ultils';
import { DomHandler } from '@options/dom-handler';
import { ConnectedOverlayScrollHandler } from '@options/connected-overlay-scroll-handler';
...
export class TooltipDirective implements AfterViewInit, OnDestroy {
  ...
  _tooltipOptions = {
    ...
    autoHide: true,
    hideOnEscape: true,
    id: this.uniqueComponentId() + '_tooltip'
  };
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: any, public el: ElementRef, public zone: NgZone, private renderer: Renderer2, private viewContainer: ViewContainerRef) { }
  ...
  show() {
    ...
    if (this.getOption('tooltipZIndex') === 'auto') ZIndexUtils.set('tooltip', this.container, 1100);
