...
import { IBreadcrumb } from 'ngx-dynamic-breadcrumb';
...
export class DefaultLayoutComponent extends InjectBase implements OnInit, OnDestroy {
  ...
  navigateTo(breadcrumb: IBreadcrumb) {
    if (breadcrumb.isClickable == true)
