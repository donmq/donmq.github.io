...
{
    public class ProductionT1ModelPreparationService : IProductionT1ModelPreparationService
    {
        private readonly IRepositoryAccessor _repoAccessor;

        public ProductionT1ModelPreparationService(
        ...
        public async Task<List<eTM_VideoDTO>> GetModelPreparation(string deptId)
        {
            ...
            var data = await videoQuery.Join(teamUnitQuery,
                ...
                .Where(x => x.videoQuery.Video_Kind == Common.KIND_MODELPREPARATION
