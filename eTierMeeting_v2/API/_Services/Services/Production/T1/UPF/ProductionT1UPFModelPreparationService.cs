...
{
    public class ProductionT1UPFModelPreparationService : IProductionT1UPFModelPreparationService
    {
        private readonly IRepositoryAccessor _repoAccessor;

        public ProductionT1UPFModelPreparationService(IRepositoryAccessor repoAccessor)
        {
        ...
        public async Task<List<eTM_VideoDTO>> GetModelPreparation(string deptId)
        {
            ...
            var data = await videoQuery.Join(teamUnitQuery,
                                ...
                                .Where(x => x.video.Video_Kind == Common.KIND_MODELPREPARATION &&
