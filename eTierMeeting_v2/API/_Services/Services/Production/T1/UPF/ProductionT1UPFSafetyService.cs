...
{
    public class ProductionT1UPFSafetyService : IProductionT1UPFSafetyService
    {

        private readonly IRepositoryAccessor _repoAccessor;
        public ProductionT1UPFSafetyService(
